...
<body>
	<div class="content">
		...
		<div class="conmain">
			<g:form url="[action:'getUser',controller:'inheritedConditions']">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>
							<g:link controller="inheritedConditions" action="showAllInheritedConditions" id="${userInstance.id }">编辑生命谱</g:link>
						</td>
					</tr>
				</g:each>
			</table>
