...
<table>
  ...
  <tr>
    <td class="fieldcontain ${hasErrors(bean: illnessInstance, field: 'description', 'error')} ">描述</td>
    <td><g:textArea name="description" cols="40" rows="5" maxlength="3000" value="${illnessInstance?.description}"/></td>
  </tr>
  <tr>
    <td class="fieldcontain ${hasErrors(bean: illnessInstance, field: 'averageRisk', 'error')} ">平均风险值</td>
    <td><g:textField name="averageRisk" value="${illnessInstance?.averageRisk}"/></td>
  </tr>
  <tr>
    <td class="fieldcontain ${hasErrors(bean: illnessInstance, field: 'canDo', 'error')} ">你能做什么</td>
    <td><g:textArea name="canDo" cols="40" rows="5" maxlength="3000" value="${illnessInstance?.canDo}"/></td>
  </tr>
  <tr>
    <td class="fieldcontain ${hasErrors(bean: illnessInstance, field: 'geneticEnvironment', 'error')} ">遗传与环境</td>
