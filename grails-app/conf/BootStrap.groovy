...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		RiskRank riskRank=new RiskRank(high:10,low:-10);
...
//		Gene gene=new Gene(name:"rs10757278(A;A)",magnitude:"4",repute:"good",description1:"0.78x reduced risk for Coronary Heart Disease.",description2:"0.77x reduced risk for Brain Aneurysm and Abdominal Aortic Aneurysm.");
